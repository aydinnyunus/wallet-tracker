...
docker exec -e NEO4J_USERNAME="$NEO4J_USERNAME" -e NEO4J_PASSWORD="$NEO4J_PASS" neo4j cypher-shell -u "$NEO4J_USERNAME" -p "$NEO4J_PASSWORD" "ALTER USER $NEO4J_USERNAME SET PASSWORD '$NEO4J_PASSWORD';"
